...
#driver = webdriver.Chrome('/var/lib/jenkins/.local/bin/chromedriver-path')
#driver = webdriver.Chrome('/var/lib/jenkins/.local/lib/python3.8/site-packages/chromedriver_binary/')
driver = webdriver.Chrome(executable_path='/var/lib/jenkins/workspace/Andrew_Izmaylov_Homework19_job/mychromedriver/chromedriver')
new_user_name = "rando"
